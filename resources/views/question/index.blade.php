...
<div class="container mx-auto py-10">
    ...
    <div class="space-y-6">
        <!-- 1. Otázka -->
        <div>
            <button class="w-full text-left text-xl font-medium text-white bg-green-800 px-6 py-4 rounded-lg flex justify-between items-center transition duration-300 ease-in-out hover:bg-green-700 focus:outline-none"
                    onclick="toggleAnswer(this)">
                Jak dlouho trvá zpracování mé objednávky?
                <span class="ml-4">+</span>
            </button>
            <div class="hidden mt-2 bg-green-900 text-white px-6 py-4 rounded-lg shadow-md">
